module github.com/polygon/procyon
...
replace (
	...
	// Local module integration for dev convenience for now
	github.com/polygon/envoy => ../envoy/
...
require github.com/polygon/envoy v0.0.0-00010101000000-000000000000
